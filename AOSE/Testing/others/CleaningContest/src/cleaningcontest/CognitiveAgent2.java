 ...
 * @author Humam
 */
public class CognitiveAgent2 {
   
  public static String CA2="CA2";        
  public static String AgentType="Cognitive"; 
  int face;
    ...
    public void move(String agent)
    {
        ...
        
        {
            case 0:
                if (moves%5==0 || i + 1 > 10||position[i+1][j].getText().equalsIgnoreCase("O")) {
                    ...
                    }else if ( i == CognitiveAgent1.i&&j==CognitiveAgent1.j)
                    {
                        score =(CognitiveAgent1.score+score)/2;
                         CognitiveAgent1.score=score;
                        System.out.println("Score devided between CA2 and CA1"+" CA2 = "+score);
                        Environment.position[i ][j].setText(agent);
                        Environment.position[i-1][j].setText("");
                    }else if ( i == ReactiveAgent1.i&&j==ReactiveAgent1.j)
                    {
                        ...
                        score=0;
                        System.out.println("CA2 lost his score RA1 score become "+ReactiveAgent1.score);
                        Environment.position[i ][j].setText(agent);
                        Environment.position[i-1][j].setText("");
                    }
                    else if ( i == ReactiveAgent2.i&&j==ReactiveAgent2.j)
                    {
                        ...
                        score=0;
                        System.out.println("CA2 lost his score RA2 score become "+ReactiveAgent2.score);
                        Environment.position[i ][j].setText(agent);
                        Environment.position[i-1][j].setText("");
         ...
         if (Environment.objects==0)
        {
            for (int i=0;i<11;i++){
             ...
             position[10][0].setText(ReactiveAgent1.RA1);
             position[0][10].setText(ReactiveAgent2.RA2);
