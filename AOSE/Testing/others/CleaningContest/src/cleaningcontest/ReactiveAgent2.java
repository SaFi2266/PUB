...
import static cleaningcontest.CognitiveAgent1.moves;
import static cleaningcontest.Environment.position;
import java.util.Random;
import javax.swing.JOptionPane;


public class ReactiveAgent2 {
   
    public static String RA2="RA2";        
    public static String AgentType="Reactive"; 
    int face;
        ...
        switch(face)
        {
            case 0:
                if (moves%5==0 || i + 1 > 10 ||position[i+1][j].getText().equalsIgnoreCase("O")) {
                    ...
                    {
                        score = (ReactiveAgent1.score+score)/2;
                         ReactiveAgent1.score=score;
                        System.out.println("Score devided between RA2 and RA1"+" RA2 = "+score);
                        Environment.position[i ][j].setText(agent);
                        Environment.position[i-1][j].setText("");
                    }
