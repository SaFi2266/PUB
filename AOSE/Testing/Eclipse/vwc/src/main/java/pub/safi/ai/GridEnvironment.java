...
public abstract class GridEnvironment extends Environment implements Cloneable
{
	...
	public Location size;			// The size of the grid.
	public Object grid[][];			// The grid of cells.   
	public boolean visited[][];		// Indicates whether a cell has been visited or not.
	public Location start;			// The starting location.	    
	public GridCanvas canvas;		//  The grid display. 
	GridPanel gridPanel;			// The control panel.	
